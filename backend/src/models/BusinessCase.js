...
const BusinessCase = sequelize.define('BusinessCase', {
  ...
  bcCode: { type: DataTypes.STRING, allowNull: true, unique: true },
  bcTitle: { type: DataTypes.STRING, allowNull: false },
  bcType: { type: DataTypes.ENUM('Non-BC', 'BC-CPB', 'BC'), allowNull: false },
  cpbDate: { type: DataTypes.DATEONLY, allowNull: true },
  projectType: { type: DataTypes.ENUM('Non-Tender', 'Tender'), allowNull: false },
  activityType: { type: DataTypes.ENUM('BAU', 'Non BAU'), allowNull: false },
  projectStatus: {
  ...
  custJoinYear: { type: DataTypes.INTEGER, allowNull: true },
  lineOfBusiness: {
    type: DataTypes.ENUM(
  ...
  contractType: { type: DataTypes.ENUM('Existing', 'New'), allowNull: false },
  activationType: {
  ...
  // Financial - PPR
  pprEligibility: { type: DataTypes.ENUM('Eligible', 'Not Eligible'), allowNull: true },
  pprStatus: { type: DataTypes.ENUM('On Progress', 'Done'), allowNull: true },
  // Financial - Cost
  ...
  totalOpex: { type: DataTypes.BIGINT, allowNull: true },
  // Financial - EBITDA
